...
export const pluginsData: VuePlugin[] = [
  ...
  },
  {
    ...
    "tags": ["drag-drop", "lists", "interaction", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "swiper-vue",
  ...
  },
  {
    ...
    "author": "VueUse Team",
    "tags": ["composition", "utilities", "reactivity", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vuetify",
  ...
  },
  {
    ...
    "author": "Quasar Team",
    "tags": ["material", "UI", "components", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "headlessui-vue",
    ...
    "tags": ["headless", "accessible", "components", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "element-plus",
    ...
    "tags": ["UI", "components", "typescript", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "naive-ui",
    ...
    "author": "TuSimple",
    "tags": ["UI", "components", "typescript", "themes", "vue3", "community"],
    "type": "community"
  },
  {
  ...
  },
  {
    ...
    "author": "TanStack",
    "tags": ["data-fetching", "caching", "synchronization", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vueuse-core",
  ...
  },
  {
    ...
    "tags": ["modal", "dialog", "overlay", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-emoji-picker",
    ...
    "tags": ["emoji", "picker", "input", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-demi",
    ...
    "author": "VueUse Team",
    "tags": ["compatibility", "universal", "vue2", "vue3", "community"],
    "type": "community"
  },
    {
    "id": "animated-vue",
  ...
  },
  {
    ...
    "documentationUrl": "https://motion.vueuse.org/",
    "author": "VueUse Team",
    "tags": ["animation", "motion", "composable", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-chartjs",
    ...
    "author": "Apertureless",
    "tags": ["charts", "data-visualization", "canvas", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-tiptap",
    ...
    "author": "Tiptap Team",
    "tags": ["rich-text", "editor", "collaborative", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "tags": ["toast", "notifications", "alerts", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "tags": ["virtual-scrolling", "performance", "large-lists", "vue3", "community"],
    "type": "community"
  },
  {
  ...
  },
  {
    ...
    "description": "Vue 3 composables for gesture recognition (drag, pinch, swipe).",
    "category": "UI Framework",
    "packageName": "@vueuse/gesture",
    "githubUrl": "https://github.com/vueuse/gesture",
    "npmUrl": "https://www.npmjs.com/package/@vueuse/gesture",
    "documentationUrl": "https://gesture.vueuse.org/",
    "author": "VueUse Team",
    "tags": ["gestures", "touch", "interaction", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-color-kit",
    ...
    "author": "Anish Kumar",
    "tags": ["color-picker", "colors", "input", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-pdf-embed",
    ...
    "tags": ["pdf", "document", "viewer", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-clipboard3",
    ...
    "author": "Jamie Curnow",
    "tags": ["clipboard", "copy", "directive", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-masonry-wall",
    ...
    "author": "Fuxing Loh",
    "tags": ["masonry", "layout", "grid", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "author": "mengxiong10",
    "tags": ["datepicker", "calendar", "forms", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-flow",
    ...
    "tags": ["flow-chart", "diagram", "nodes", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-use-sound",
    "name": "Vue Use Sound",
    "description": "Vue 3 composable for playing sound effects with Web Audio API.",
    "category": "Utilities",
    "packageName": "vue-use-sound",
    "githubUrl": "https://github.com/vueuse/sound",
    "npmUrl": "https://www.npmjs.com/package/vue-use-sound",
    "documentationUrl": "https://sound.vueuse.org/",
    "author": "VueUse Team",
    "tags": ["audio", "sound", "web-audio", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-meta",
    ...
    "author": "UnJS Team",
    "tags": ["meta", "seo", "head", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-select",
    ...
    "author": "Jeff Sagal",
    "tags": ["select", "dropdown", "forms", "search", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-multiselect",
    ...
    "tags": ["multiselect", "tagging", "forms", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-test-utils",
    ...
    "author": "Vue.js Team",
    "tags": ["testing", "unit-tests", "official", "vue3"],
    "type": "official"
  },
  {
    "id": "vue-apollo",
    ...
    "author": "Vue.js Team",
    "tags": ["graphql", "apollo", "data-fetching", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vite-pwa",
    ...
    "tags": ["pwa", "vite", "offline", "service-worker", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-gtag",
    ...
    "tags": ["analytics", "google-analytics", "tracking", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-echarts",
    ...
    "author": "Baidu EFE",
    "tags": ["charts", "echarts", "data-visualization", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "tags": ["loading", "overlay", "spinner", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-confetti",
    "name": "Vue Confetti",
    "description": "Confetti animation component for Vue 3 to celebrate user interactions.",
    "category": "Animation",
    "packageName": "@vue-confetti/vue",
    "githubUrl": "https://github.com/vue-confetti/vue-confetti",
    "npmUrl": "https://www.npmjs.com/package/@vue-confetti/vue",
    "documentationUrl": "https://vue-confetti.github.io/",
    "author": "Vue Confetti Team",
    "tags": ["confetti", "animation", "celebration", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-good-table",
    ...
    "author": "Boris Flesch",
    "tags": ["table", "data-grid", "sorting", "filtering", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-cropper",
    ...
    "author": "xyxiao001",
    "tags": ["image", "crop", "photo-editing", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-qr-code",
    "name": "Vue QR Code",
    "description": "QR code generator component for Vue 3 with customization options.",
    "category": "UI Framework",
    "packageName": "vue-qr-code",
    "githubUrl": "https://github.com/fengyuanchen/vue-qr-code",
    "npmUrl": "https://www.npmjs.com/package/vue-qr-code",
    "documentationUrl": "https://github.com/fengyuanchen/vue-qr-code#readme",
    "author": "Chen Fengyuan",
    "tags": ["qr-code", "generator", "barcode", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "author": "Peng Jie",
    "tags": ["signature", "canvas", "forms", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "author": "kangc",
    "tags": ["markdown", "editor", "preview", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "author": "LianYue",
    "tags": ["upload", "file", "drag-drop", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-socket-io",
    ...
    "author": "Illya Klymov",
    "tags": ["socket.io", "websocket", "real-time", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-star-rating",
    ...
    "author": "Craig Harman",
    "tags": ["rating", "stars", "feedback", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-timeago",
    "name": "Vue Timeago",
    "description": "Time ago component for Vue 3 with internationalization support.",
    "category": "Utilities",
    "packageName": "vue-timeago3",
    "githubUrl": "https://github.com/runkids/vue-timeago",
    "npmUrl": "https://www.npmjs.com/package/vue-timeago3",
    "documentationUrl": "https://github.com/runkids/vue-timeago#readme",
    "author": "runkids",
    "tags": ["time", "date", "timeago", "i18n", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-lazyload",
    ...
    "author": "murongg",
    "tags": ["lazyload", "images", "performance", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-cookies",
    ...
    "author": "cmp-cc",
    "tags": ["cookies", "storage", "browser", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "author": "GS Shop",
    "tags": ["carousel", "slider", "responsive", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-context-menu",
    "name": "Vue Context Menu",
    "description": "Context menu component for Vue 3 with keyboard navigation.",
    "category": "UI Framework",
    "packageName": "vue-context-menu",
    "githubUrl": "https://github.com/johndatserakis/vue-context-menu",
    "npmUrl": "https://www.npmjs.com/package/vue-context-menu",
    "documentationUrl": "https://github.com/johndatserakis/vue-context-menu#readme",
    "author": "John Datserakis",
    "tags": ["context-menu", "right-click", "menu", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-notification",
    ...
    "author": "euvl",
    "tags": ["notifications", "alerts", "toasts", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-cal",
    ...
    "author": "Antoni Andre",
    "tags": ["calendar", "events", "scheduling", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-highlightjs",
    ...
    "author": "Gluons",
    "tags": ["syntax-highlighting", "code", "highlighting", "vue3", "community"],
    "type": "community"
  },
  {
    "id": "vue-progressbar",
    ...
    "author": "hilongjw",
    "tags": ["progress", "loading", "bar", "vue3", "community"],
    "type": "community"
  },
  {
    ...
    "author": "Guillaume Chau",
    "tags": ["visibility", "intersection-observer", "scroll", "vue3", "community"],
    "type": "community"
  }
]
